...
patch(CashMovePopup.prototype, {
    ...
    _getCashCurrencies() {
        ...
        const currencyModel = this.pos.data.models["res.currency"];
        const currencies = [];
    ...
    getSelectedCurrency() {
        ...
        const currency = this.pos.data.models["res.currency"]?.get(currencyId);
    ...
    getPayload() {
        const payload = super.getPayload(...arguments);
        payload.currency_id = this.cashCurrencyState.currency_id;
        return payload;
    },
    ...
    async confirm() {
        ...
        const extras = { formattedAmount, formattedAmountSymbol, translatedType, currency_id: currencyId };
        const screenProps = {
        ...
        this.pos.showScreen("KiCashMoveReceiptScreen", screenProps);
    },
});
